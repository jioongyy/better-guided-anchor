...
def bga_target_single(flat_proposals,
                      valid_flags,
                      gt_bboxes,
                      gt_bboxes_ignore,
                      gt_labels,
    ...
    if unmap_outputs:
        # 将所有的结果都放到原来flat_proposal的大小中
        # 因为之前计算时，使用valid_flag将无效的proposal筛去，取了flat_proposal子集
        # 此时要把结果放在flat_proposal的size的集合中
