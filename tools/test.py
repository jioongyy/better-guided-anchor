...
from mmdet.apis import multi_gpu_test, single_gpu_test, aug_single_gpu_test
...
def parse_args():
    ...
    parser.add_argument('--store_proposal',action='store_true')
...
def main():
    ...
    if not distributed:
        ...
        outputs = aug_single_gpu_test(model, data_loader, args.store_proposal)
    else:
